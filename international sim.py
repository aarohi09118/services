...
driver.find_element(By.XPATH,"(//button[@class='SingleDatePickerInput_calendarIcon SingleDatePickerInput_calendarIcon_1'])[1]").click()
driver.find_element(By.XPATH,"(//td[text()='31'])[2]").click()
driver.find_element(By.XPATH,"(//button[@class='SingleDatePickerInput_calendarIcon SingleDatePickerInput_calendarIcon_1'])[2]").click()
...
driver.find_element(By.XPATH,"//input[@placeholder='Address']").send_keys("test")
driver.find_element(By.XPATH,"//input[@placeholder='Location']").send_keys("Noida")
...
driver.find_element(By.XPATH,"//input[@placeholder='State']").send_keys("UP")
