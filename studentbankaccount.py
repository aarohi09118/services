...
driver.find_element(By.XPATH,"(//p[text()='Local bank account for seamless payments & transactions'])[2]").click()
driver.find_element(By.ID,"country").click()
time.sleep(5)
driver.find_element(By.XPATH,"//option[text()='Canada']").click()
driver.find_element(By.XPATH,"//div[text()='Open Account']").click()
time.sleep(5)
